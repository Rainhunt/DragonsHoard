...
//             {isModifier ?
//                 <>
//                     <FormField name={"value"} type="number" required={required} placeholder={`${placeholder} value`} ariaLabel={ariaLabel} />
//                     <FormField name={"source"} required={required} placeholder={`${placeholder} source`} ariaLabel={ariaLabel} />
//                 </> :
//                 <>
