...
import getMonsters from "../../services/requests/monsters/getMonsters/request";
    ...
    return (
        <SearchableDataProvider fetch={async () => await getMonsters()}>
            ...
            <Scroll className='monsters-filters' width="100%">
                <SearchFilter />
                <DropDownFilter<MonsterSchema> id="alignment" label="Alignment" />
                <DropDownFilter<MonsterSchema> id="biome" label="Biome" />
                <CrFilter />
            </Scroll>
